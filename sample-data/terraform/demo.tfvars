...
sample_connection_project = "aef-demo-4"
sample_connection_region = "us-central1"

sample_data_bucket_project = "aef-demo-4"
...
temp_data_bucket_project = "aef-demo-4"

sample_ddl_bucket_project  = "aef-demo-4"
...
sample_ddl_files = {
  ...
  "bank" = {
    name = "bank_info.sql"
    source = "../gcs-files/bank_info.sql"
  }
}
